...
def main():
    ...
    for hap in range(1,haps+1):
        print(hap)
        matchfile="rsync_data/matches/100_individuals_testgc/matches_wbackgroundgc_windowsize{}_hap{}.txt".format(window_size,hap)
        gcofile="rsync_data/simulated_data/100_individuals_testgc/admixed_w_backgroundgc_gcotable_{}.txt".format(hap)
    ...
    results_df.to_csv("results/100_individuals_testgc/results_windowsize{}.txt".format(window_size),na_rep='NULL',sep='\t')
